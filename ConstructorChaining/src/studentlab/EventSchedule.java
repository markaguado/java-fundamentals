...
public class EventSchedule {
	...
	/**
	 * Sets the day of this EventSchedule, in kg.
	 * @param day The day of this EventSchedule in kg.
	 */
	 ...
	 * by a comma in the order of year, month, day with (kg) added
	 * to the end of the day field value.
	 */
